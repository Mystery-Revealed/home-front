...
app.get('/healthz', (_req, res) =>
  res.json({ ok: true, service: 'home-front', liveSessions: manager.registry.sessions.size }));
...
server.listen(config.port, () => {
  console.log(`[home-front] listening on :${config.port} — sessions live in memory only`);
});
